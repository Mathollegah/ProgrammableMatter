from robots.constauto.states.FindLocalMaximum import *
from robots.constauto.states.FindShiftableLine import *
from robots.constauto.states.MoveOnSurface import *
from robots.constauto.states.ShiftOrTake import *
import globalvars
import random
